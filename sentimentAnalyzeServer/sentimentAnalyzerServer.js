...
//  the problem is in ALL  the functions, so it could be  stemming from this shared function
function getNLUInstance() {

    console.log("starting new NLU instance...")
    ...
    console.log("returning instance of NLU...")
